...
var db = mongojs('mongodb://admin:123456@ds153729.mlab.com:53729/userdb001', ['UserInfo']);
...
const checkJwt = jwt({
    ...
    secret: jwksRsa.expressJwtSecret({
        ...
        jwksUri: 'https://proyectoapp.auth0.com/.well-known/jwks.json'
      }),

      // Validate the audience and the issuer.
      audience: process.env.AUTH0_AUDIENCE,
      issuer: 'https://proyectoapp.auth0.com/',
      algorithms: ['RS256']
    });
...
app.use(express.static(path.join(__dirname, '../client/UserManagement/dist/UserManagement')));
